/***************************************************************
 * Name:      cbClangCompileCommands
 * Purpose:   Code::Blocks plugin
 * Author:    Yves De Muyter (yves@alfavisio.be)
 * Created:   2016-12-10
 * Copyright: Yves De Muyter
 * License:   GPL
 **************************************************************/

#ifndef CBCLANGCOMPILECOMMANDS_H_INCLUDED
#define CBCLANGCOMPILECOMMANDS_H_INCLUDED
...
class cbClangCompileCommands : public cbPlugin
{
    public:
        /** Constructor. */
        cbClangCompileCommands();
        /** Destructor. */
        virtual ~cbClangCompileCommands();
        ...
        /** Return the plugin's configuration priority.
          ...
          */
        virtual int GetConfigurationPriority() const { return 100; }
...
#endif // CBCLANGCOMPILECOMMANDS_H_INCLUDED
